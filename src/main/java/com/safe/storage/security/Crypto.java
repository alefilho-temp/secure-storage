...
public class Crypto {
    ...
    // public static long obfuscate(long number) {
    //     long multipliedNumber = number * 2L; // Use long to avoid overflow

    //     String strNumber = Long.toString(multipliedNumber);

    //     StringBuilder merged = new StringBuilder();
    //     for (int i = 0; i < strNumber.length(); i++) {
    //         merged.append(strNumber.charAt(i));
    //         merged.append(strNumber.charAt(i));
    //     }

    //     return Long.parseLong(merged.toString());
    // }

    // public static long deobfuscate(long obfuscatedNumber) {
    //     String strObfuscated = Long.toString(obfuscatedNumber);

    //     StringBuilder originalString = new StringBuilder();
    //     for (int i = 0; i < strObfuscated.length(); i += 2) {
    //         originalString.append(strObfuscated.charAt(i));
    //     }

    //     long multipliedNumber = Long.parseLong(originalString.toString());

    //     return (long) (multipliedNumber / 2);
    // }

    ////

    // private static final long MODULUS = 0x100000000L; // A large prime number
    // private static final long ADDITION_KEY = 0x1234567890abcdefL; // Fixed addition key

    // public static long obfuscate(long value) {
    //     return value + ADDITION_KEY; // Obfuscate by adding a fixed key
    // }

    // public static long deobfuscate(long obfuscatedValue) {
    //     return obfuscatedValue - ADDITION_KEY; // Decode by subtracting the same key
    // }
    ...
    public static long obfuscate(long value) {
        // Use XOR with a fixed key to obfuscate
        return (value ^ ADDITION_KEY);
    }

    public static long deobfuscate(long obfuscatedValue) {
        // Use XOR with the same fixed key to retrieve the original value
        return (obfuscatedValue ^ ADDITION_KEY);
    }
